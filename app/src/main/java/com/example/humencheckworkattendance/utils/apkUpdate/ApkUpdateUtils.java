package com.example.humencheckworkattendance.utils.apkUpdate;
...
import com.example.humencheckworkattendance.utils.SpUtils;
...
public class ApkUpdateUtils {
    ...
    public static void download(Context context, String url, String title) {
        long downloadId = (long) SpUtils.get(DOWNLOAD_ID, -1L);
        if (downloadId != -1L) {
