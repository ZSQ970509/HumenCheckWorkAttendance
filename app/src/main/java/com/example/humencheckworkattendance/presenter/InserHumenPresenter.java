...
import com.example.humencheckworkattendance.ui.activity.InsertHumenActivity;
...
public class InserHumenPresenter extends BasePresenter<InsertHumenActivity> implements InsertHumenContact.InsertHumenPresenter {
    @Override
