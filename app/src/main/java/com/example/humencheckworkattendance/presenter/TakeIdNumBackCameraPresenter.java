...
public class TakeIdNumBackCameraPresenter extends BasePresenter<TakeIdNumCameraActivity> implements TakeIdNumCameraContact.TakeIdNumCameraPresenter{
    @Override
    ...
    public HashMap<String, IModel> loadModelMap(IModel... models) {
        ...
        map.put("TakeIdNumBackCamera", models[0]);
        return map;
    }
