...
public class HomePageActivity extends BaseActivity<HomePagePresenter> implements HomePageContact.HomePageView{
    ...
    @BindView(R.id.imageView_Insert_Humen)
    ImageView imageViewInsertHumen;
    ...
    @OnClick({R.id.home_page_camera,R.id.home_page_sign,R.id.linearLayout_Map,R.id.imageView_Histroy,R.id.relativeLayout_Insert_Humen})
