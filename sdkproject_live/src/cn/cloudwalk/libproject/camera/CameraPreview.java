        ...
        if (mCamera != null) {
            try {
                ...
                try {
                    ...
                    if (!(params.getMaxExposureCompensation()==0&&params.getMinExposureCompensation()==0)) {//判断是否支持自动曝光
                        if (DEFAULT_EXPOSURE<=params.getMaxExposureCompensation()) {
                            params.setExposureCompensation(DEFAULT_EXPOSURE);//设置默认曝光值DEFAULT_EXPOSURE
